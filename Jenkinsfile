...
// for display purposes
      ...
      git 'https://github.com/dkumar-m/hello-world-servlet.git'
...
post {
        success {
            mail to:"kumarsites7@gmail.com", subject:"SUCCESS: ${currentBuild.fullDisplayName}", body: "Build success"
        }
        failure {
            mail to:"kumarsites7@gmail.com", subject:"FAILURE: ${currentBuild.fullDisplayName}", body: "Build failed"
        }
    }       
}
